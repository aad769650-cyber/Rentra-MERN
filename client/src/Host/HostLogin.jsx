...
import { verifyHostLogin } from '../api/apiCall';
...
export default function HostLogin() {
 ...
 try{
  const resp= verifyHostLogin(formData).then((data)=>{
  if(data.status==200){
                setFormData({  
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-linear-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 rounded-lg shadow-lg transform transition-all duration-200 hover:from-blue-700 hover:to-indigo-700 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
              Sign In
            </button>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-lg hover:border-gray-300 hover:bg-gray-50 transition-all duration-200 group"
              >
