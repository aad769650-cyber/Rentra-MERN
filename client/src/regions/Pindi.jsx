...
const [isDesktop,setIsDesktop]=useState(true)
  ...
  const apiCall = async () => {
    try {
      const resp = await axios.get("https://rentra-mern.onrender.com/api/pindi");
  ...
  return (
    <>
      <div className="flex justify-between items-center p-4">
        <div className="p-2">Stay near Pindi</div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-2 p-4">
        {items.map((curr) => {
          return (
            ...
            <NavLink to={`/city/pindi/id/${curr.id}`}>
                  <img
                  src={curr.pic}
                  alt="room img"
